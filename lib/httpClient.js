...
var HttpClient = module.exports = function HttpClient(host, port, apiKey){
    ...
    this.get = function(path, callback){
        httpRequest('GET', path, {'accept': 'application/json', 'X-API-KEY': apiKey}, null, callback);
    }

    this.post = function(path, data, callback){
        httpRequest('POST', path, {'Content-Type': 'application/json', 'X-API-KEY': apiKey}, data, callback);
    }
