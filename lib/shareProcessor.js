...
var ShareProcessor = module.exports = function ShareProcessor(config, logger){
    ...
    function persistShare(db, share){
        db.query(
            ...
            [share.job.fromGroup, share.job.toGroup, share.difficulty, share.shareDiff, share.worker, share.foundBlock],
            function(error, result){
                ...
                if (share.foundBlock){
                    ...
                    db.query(
                        ...
                        [shareId, share.job.fromGroup, share.job.toGroup, share.blockHash.toString('hex'), share.worker],
                        function(error, _){
